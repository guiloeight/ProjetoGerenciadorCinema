...
namespace AppCadastro
{
    public partial class Produtos : Form
    {
        ...
        private void btnRemover_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string strSql = "Select * From tblprodutos Where codigo = " + txtCodigo.Text + "";
                    ...
                    {
                        MessageBox.Show("Produto Inexistente!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            if (txtCodigo.Equals(""))
            {
                MessageBox.Show("Habilite o campo Código e Preencha o código que deseja alterar!", "Código Vazio", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                int usuario = 1;
