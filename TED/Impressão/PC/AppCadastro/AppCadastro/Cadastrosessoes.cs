...
namespace AppCadastro
{
    public partial class Cadastrosessoes : Form
    {
        ...
        {
            if (cbxfilme.Text.Equals("") || txthorario.Text.Equals("") || lbsala.Text.Equals("") || cbx3d.Text.Equals(""))
            {
            ...
            else
            {
                try
                {
                    ...
                    strSql = "Insert into tblcadastrosessoes (filme,d3,horario,sala,nome,try) values(";
                ...
                catch
                {
                    ...
                    MessageBox.Show("Esta sala já esta sendo utilizada neste horário.", "Erro!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    btnLimpar_Click();
                }
        ...
        {
            gridsessoes grid = new gridsessoes();
            grid.ShowDialog();
        }
