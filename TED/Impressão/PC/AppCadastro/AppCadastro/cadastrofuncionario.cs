        ...
        private void btncadastrar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    string strSql = "Insert into tblfuncionario (bairro,cidade,complemento,cpf,email,endereco,estado,numero,nome,estadocivil,rg,sexo,telefone1,telefone2) values(";
