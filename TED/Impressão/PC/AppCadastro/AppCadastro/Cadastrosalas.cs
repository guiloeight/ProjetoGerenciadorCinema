    ...
    public partial class Cadastrosalas : Form
    {
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    string strSql = "Select * From tblcliente Where codigo = " + txtnumerodasala.Text + "";
                    pblCmd.Connection = pblCnx;
                    pblCmd.CommandText = strSql;
        ...
        private void btnconsultar_Click(object sender, EventArgs e)
        {
             ...
             try
            {
                ...
                ssql = "Select * From tblsalas Order By codigo ";
                ...
                else
                {
                    ...
                    {
                        dgvsala.Rows.Add(pblDataReader["codigo"].ToString(), pblDataReader["ndesalas"].ToString(), pblDataReader["ndelugares"].ToString());
                    }
                }
                pblDataReader.Close();
            }
